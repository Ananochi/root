...
class TestFactorizer {
  public static void main(String[] args) {
    ...
    final Factorizer2 factorizer = new CachingFactorizer();
...
interface Factorizer2 {
  public long[] getFactors(long p);
  public long getCount();
}

// Like Goetz p. 18
class StatelessFactorizer implements Factorizer2 {
  public long[] getFactors(long p) {
...
class UnsafeCountingFactorizer implements Factorizer2 {
...
// Like Goetz p. 23
class CountingFactorizer implements Factorizer2 {
...
class UnsafeCachingFactorizer implements Factorizer2 {
...
class TooSynchronizedCachingFactorizer implements Factorizer2 {
...
// Like Goetz p. 31.
class CachingFactorizer implements Factorizer2 {
  private long lastNumber = 1;
  private long[] lastFactors = new long[0];
...
// Like Goetz p. 50.
class VolatileCachingFactorizer implements Factorizer2 {
